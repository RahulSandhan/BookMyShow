...
class TicketControllerTest {
    ...
    /*
    3 scenarios:
    1. Validation fails - Negative scenario
    2. Ticket service fails - Negative scenario
    3. Ticket service passes and gives a ticket object - Positive scenario
     */
    ...
    public void testBookTicket_ShowIdNegative() throws Exception {
        ...
        when(ticketService.bookTicket(requestDto.getUserId(), requestDto.getShowId(), requestDto.getShowSeatIds())).thenThrow(Exception.class);
    ...
    public void testBookTicket_Positive() throws Exception {
        ...
        when(ticketService.bookTicket(requestDto.getUserId(), requestDto.getShowId(), requestDto.getShowSeatIds())).thenReturn(new Ticket());
